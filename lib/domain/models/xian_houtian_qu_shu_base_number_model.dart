...
/// 条文扩展使用±48×倍数（2,4,8,16）
class XianHoutianQuShuBaseNumberModel extends BaseNumberModel {
  // ========== 输入参数 (4个字段) ==========
  ...
  /// 构造函数
  const XianHoutianQuShuBaseNumberModel({
  ...
  /// 工厂构造函数（简化创建）
  factory XianHoutianQuShuBaseNumberModel.create({
    ...
    return XianHoutianQuShuBaseNumberModel(
  ...
  /// 复制并更新模型
  @override
  XianHoutianQuShuBaseNumberModel copyWith({
    int? baseNumber,
    String? name,
    String? description,
  ...
  bool operator ==(Object other) {
    ...
    return other is XianHoutianQuShuBaseNumberModel &&
