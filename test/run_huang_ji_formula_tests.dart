...
void main() async {
  ...
  final jsonTestFile = File(
    'test/domain/models/huang_ji_formula_json_test.dart',
  );
  ...
  final integrationTestFile = File(
    'test/domain/models/huang_ji_formula_raw_number_integration_test.dart',
  );
  ...
  print(
    'dart test test/domain/models/huang_ji_formula_raw_number_integration_test.dart',
  );
}
